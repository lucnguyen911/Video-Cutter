# Hướng dẫn Biên dịch & Đóng gói Video Cutter v1.0.5
...
4. File setup sẽ được tạo tại: `installer_output/Video_Cutter_Setup_v1.0.5.exe`
...
```
installer_output/
└── Video_Cutter_Setup_v1.0.5.exe    ← File setup duy nhất (~50-80 MB)
```
